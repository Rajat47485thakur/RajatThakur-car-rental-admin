...
export class BookingsComponent implements OnInit {
  ...
  bookingArray=[
    {id:1,value:'New Booking Created'},
    {id:2,value:'Host Accepted'},
    {id:3,value:'Started'},
    {id:4,value:'Ended'},
    {id:5,value:'Ended, but not confirmed'},
    {id:6,value:'Extended'}
  ]
  ...
  constructor(
    ...
    if(this.user_id)
      {
        this.getMerchandById(this.user_id)
      }
  }
...
restrickedWord(event: KeyboardEvent) {
  ...
  getMerchandById2(value)
  {
    this.router.navigate(["/host/host-details/_id"]);
  }
